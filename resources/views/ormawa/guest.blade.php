<html>
  ...
  <audio id="background-audio" autoplay loop>
    ...
    style="background-image: url({{ asset('images/theme_01_bg_profile.webp') }})">
      ...
      <span class="font-light text-lg sm:text-xl mt-4 text-center">Dengan Hormat Kami Mengundang Perwakilan Dari UKM / Ormawa / Komisariat Se Ruang Lingkup Telkom University dan Cabang Bandung:</span>

      <!-- Profile -->
      @if($guest)
          <span class="font-bold text-4xl sm:text-5xl md:text-6xl mt-8 text-center">{{ $guest->name }}</span>
      @else
          <span class="font-bold font-berkshire text-4xl sm:text-5xl md:text-6xl mt-8 text-center">Komisariat Dan UKM</span>
      @endif
    ...
    data-aos="fade-down" 
          ...
          data-aos-offset="200"
    >
      <span class="font-medium text-lg sm:text-xl md:text-2xl mt-5">Kami mengundang Saudara/i untuk hadir dalam acara Silaturahmi Akbar dan Pelantikan Pengurus HMI IT Telkom. Acara ini merupakan momen berharga bagi kami untuk mempererat tali silaturahmi antar Organisasi, serta meresmikan kepengurusan baru yang akan membawa organisasi ini ke arah yang lebih baik.</span>
      <span class="font-bold text-lg sm:text-xl md:text-2xl mt-10">Atas perhatian dan kehadirannya, kami ucapkan terima kasih.</span>
